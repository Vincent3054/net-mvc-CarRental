...
namespace WebApplication1.Services
{
    public class MembersDBService
    {
        ...
        public void Register(Members newMember)
        {
            ...
            string sql = $@" INSERT INTO Members (Account,Password,Name,Location,Email,AuthCode,IsAdmin) VALUES ('{newMember.Account}','{newMember.Password}',N'{newMember.Name}',N'{newMember.Location}','{newMember.Email}','{newMember.AuthCode}','0') ";
            //確保程式不會因執行錯誤而整個中斷
            try
            {
                //開啟資料庫連線
